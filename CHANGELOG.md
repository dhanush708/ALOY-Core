...
- **Dynamic Model Configuration**: Centralized model config in `models/config.py` defining chat (`phi4-mini`), coding (`qwen2.5-coder`), vector embeddings (`nomic-embed-text`), and reasoning (`deepseek-r1`) specifications.
